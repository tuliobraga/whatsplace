...
app.get('/detalhes-local/:id', routes.detalhesLocal);
app.get('/detalhes-universo/:id', routes.detalhesUniverso);
app.get('/detalhes-usuario/:id', routes.detalhesUsuario);
...
app.post('/in/buscar-universos', universe.search);
